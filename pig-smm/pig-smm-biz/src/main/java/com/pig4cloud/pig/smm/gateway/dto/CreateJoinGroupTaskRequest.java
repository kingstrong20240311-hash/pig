 ...
 */
@Data
@Schema(description = "创建加群任务请求")
public class CreateJoinGroupTaskRequest {
	...
	private List<TelegramGroup> targetGroupList;
	 ...
	 * 加群间隔时间
	 */
	@Schema(description = "加群间隔时间")
	private Integer timeSpacing;

	/**
	 * 同时进行的加群数量限制
	 */
	@Schema(description = "同时进行的加群数量限制")
